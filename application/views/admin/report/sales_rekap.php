<!-- Page Header-->
  <header class="page-header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-6"><h2 class="no-margin-bottom">Penjualan Rekap</h2></div>
          <div class="col-md-6">
          </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
        	<div class="block-space">
                 ...
                 <!--  <button class="btn btn-info" id="bPdf"><span class="fa fa-print"></span> PDF</button> -->
      					</td>
...
<script type="text/javascript">
	...
	$(document).on("click", "#bPint", function(){
		...
		window.open('<?php echo admin_url() ?>' + 'report/print_sales_rekap?dateStart='+dateStart+'&dateEnd='+dateEnd+'&sortBy='+sortBy,'_blank');
	})
  ...
  $(document).on("click", "#bPdf", function(){
    ...
    $.ajax({
      url : '<?php echo admin_url() ?>' + 'report/pdf_sales_rekap',
      method : 'GET',
      data : {print : 'ok'},
      success : function(){
        window.location = '<?php echo admin_url() ?>' + 'report/pdf_sales_rekap?dateStart='+dateStart+'&dateEnd='+dateEnd+'&sortBy='+sortBy
      }
    })

    /*window.open('<?php echo admin_url() ?>' + 'report/pdf_sales_rekap?dateStart='+dateStart+'&dateEnd='+dateEnd+'&sortBy='+sortBy,'_blank');*/
  })
