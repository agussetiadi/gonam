<!-- Page Header-->
  <header class="page-header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-6"><h2 class="no-margin-bottom">Pembelian Detail</h2></div>
          <div class="col-md-6">
          </div>
        </div>
    </div>
...
<script type="text/javascript">
  ...
  $(document).on("click", "#bPint", function(){
    ...
    window.open('<?php echo admin_url() ?>' + 'report/print_pembelian_detail?dateStart='+dateStart+'&dateEnd='+dateEnd+'&sortBy='+sortBy,'_blank');
  })
